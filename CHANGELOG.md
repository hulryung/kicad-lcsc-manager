...
### Added
- **The IPC API plugin: entry point and `plugin.json`** ([#19](https://github.com/hulryung/kicad-lcsc-manager/issues/19)). KiCad 11 removes the SWIG API; this is the same plugin running as an IPC plugin. Not released yet: packaging the IPC build comes next.
